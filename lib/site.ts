...
// 🔓 **Every file here is generated by `scripts/build-partner-logos.mjs` onto
// ONE shared canvas, and that is what makes the row read as one size.** The
// sources live in the gitignored `pictures/partners/`; the outputs are
// committed. Adding or swapping a partner means editing that script's list,
// re-running it, and editing this one to match — dropping a logo straight into
// `public/partners/` puts an un-normalised mark in the row.
export const PARTNERS = [
  { name: "KPMG", logo: "/partners/kpmg.png" },
  { name: "PwC", logo: "/partners/pwc.png" },
  { name: "EY", logo: "/partners/ey.png" },
  { name: "PepsiCo", logo: "/partners/pepsico.png" },
] as const;
