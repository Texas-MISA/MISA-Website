...
- 🪤 **The site header's nav cannot grow without measuring at 1280.** The wordmark is absolutely centred and wins the z-order; an overflowing item disappears rather than wrapping. 🔓 **RE-MEASURED 2026-09-18: 342px clearance left, 430px right** (was 342/295 on 2026-08-23, and 285/312 before that). Left group 225px, right cluster 137px (was 272 — the member portal folded Leaderboard and My Attendance into one "Portal" item), wordmark 82px, 32px gutter. **The left is the tighter side again.** Relisting `/projects` spends part of the left; any sixth item needs a fresh measurement. (See `DESIGN.md` §Nav clearance.)
