...
**Stages 0–5 complete; Stage 6 (member directory) in progress — phases 1, 2a, 2, and 3 of 9 built, merged, and deployed 2026-08-02 (doc v1.29). Phase 4 is underway on `stage-6-member-directory`: its schema half is built and local-only.** Stage 6 merges to `main` at the end of each phase rather than at the end of the stage, as Stage 5 did.
