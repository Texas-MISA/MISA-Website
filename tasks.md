...
- ⏭️ **Next: v2 phase 3, the portal redesign, run THROUGH this system** — `/design-brief portal-hub` (and the other three) with the officer answering impeccable's `shape` interview. Merge order: `portal-phase-1`, then this branch.
