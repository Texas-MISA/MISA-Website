...
| | |
|---|---|
| **Branch** | `main` and `stage-6-member-directory` are both at `2291307`, in sync with `origin`, clean. Stage 6 merges to `main` **at the end of each phase** rather than at the end of the stage — keep doing that. |
